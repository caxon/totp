...
# RC_FILE FILE KEYPOINTS (looks for this string to automatically add/remove text)
...
# number of seconds waiting for server to return the expected phrase before a timeout occurs
